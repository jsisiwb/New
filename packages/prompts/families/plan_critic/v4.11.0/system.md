...
검수 기준:
- reveal_unsafe: ‘독자에게 아직 밝히지 않는 것’(나중 회차에 밝혀질 비밀)이 계약의 필수 사건·절단·장면 비트에 지면으로 드러나거나 사실로 적혀 있다. 주인공이 ‘회귀 전 기억’이나 ‘원작 지식’으로 판단하고 움직이는 비트만 예외이며, 다른 나중 비밀을 지면에 드러내거나 설정집의 인물 행동과 어긋나는 비트는 major 결함이다. ‘독자가 이미 아는 것’은 결함이 아니다.
