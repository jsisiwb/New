...
| Working branch | `hoplite/megale-polis-83bf1984` in the fork `sigma23web/New` (fork of `jsisiwb/New`, verified live). Base `hoplite/ainos-1ac771f8` at the Checkpoint 5 merge `c8cfb59`. The Checkpoint 6 work was recovered from the earlier fork `sigma21web/New:hoplite/kyrene-92b39759` at `1db2611` and preserved unmodified on the immutable branch `hoplite/megale-polis-83bf1984--checkpoint-06-recovery-1db2611`; `c8cfb59` is an ancestor of `1db2611`, and `1db2611` is an ancestor of the working branch. Staging PR: sigma23web/New#1 (draft, not to be merged) |
