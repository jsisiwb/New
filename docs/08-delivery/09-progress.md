...
| Working branch | `hoplite/delphoi-aefb0cf8` (Checkpoint 6; review PR is sigma20web/Sigma20#1, base `hoplite/maroneia-08771e8d` pinned at the `hoplite/ainos-1ac771f8` tip `c8cfb59`; this thread's source-control tooling is scoped to sigma20web/Sigma20 and cannot open PRs in jsisiwb/New — cross-repo upstream PR remains a manual step, see Checkpoint 6 row) |
